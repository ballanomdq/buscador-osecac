...
st.write("Mapa corregido: Los bordes ahora siguen las avenidas principales.")

# COORDENADAS REVISADAS PARA EVITAR CRUCES (SENTIDO HORARIO)
ZONAS_LOPEZ = [
    {
        "nombre": "Zona 1: Centro (Plaza Mitre / La Perla)",
        "coords": [
            (-37.9961, -57.5492), # 1. San Luis y 11 de Septiembre
            (-37.9995, -57.5475), # 2. Diag. Alberdi y Santiago del Estero
            (-38.0062, -57.5507), # 3. Av. Colón y Santiago del Estero
            (-38.0063, -57.5518), # 4. Av. Colón y San Luis
        ]
    },
    {
...
# Mapa base
m = folium.Map(location=[-38.0100, -57.5600], zoom_start=13)
