...
# Lista de todas las agencias posibles
AGENCIAS_TODAS = [
...
# ========== FUNCIÓN PARA CARGAR DATOS (igual que en main.py) ==========
...
def procesar_informe(df, mes, anio, dia_inicio, dia_fin, agencias_seleccionadas):
    ...
    # Definir columnas de productos (excluir metadatos)
...
if generar:
    if df_raw.empty:
        ...
        if informe is None:
            ...
            href = f'<a href="data:file/csv;base64,{b64}" download="informe_utiles.csv">📥 Descargar CSV</a>'
