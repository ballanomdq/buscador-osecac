...
# 3. CSS: TU DISEÑO ORIGINAL RESTAURADO + ARREGLO DE TEXTO
st.markdown("""
    <style>
    ...
    /* --- ARREGLO ESPECÍFICO PARA LOS INPUTS --- */
    /* Fondo oscuro para el cuadro y texto blanco al escribir */
    ...
    /* Visibilidad de los labels (Seleccione origen, etc) */
    .stWidgetLabel p, .stRadio label p {
        color: #ffffff !important;
        font-weight: 600 !important;
    }

    /* TU DISEÑO ORIGINAL DE EFECTOS */
