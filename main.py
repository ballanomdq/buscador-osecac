...
# 2. CSS PERSONALIZADO (Separando Nomencladores de Pedidos)
st.markdown("""
    <style>
    ...
    /* --- NOMENCLADORES (Celeste Original) --- */
    .nomen-box div.stLinkButton > a {
        color: #38bdf8 !important;
        border: 1px solid #334155 !important;
        background-color: #172030 !important;
    }
    .nomen-box div.stLinkButton > a:hover {
        background-color: #38bdf8 !important;
        color: #0b0e14 !important;
    }

    /* --- PEDIDOS (Colores Armónicos) --- */
    /* Rosa para Leches */
    .btn-leche div.stLinkButton > a {
        color: #ff85a2 !important;
        border: 1px solid #ff85a2 !important;
        background-color: rgba(255, 133, 162, 0.1) !important;
    }
    /* Verde para Suministros */
    .btn-sumi div.stLinkButton > a {
        color: #2dd4bf !important;
        border: 1px solid #2dd4bf !important;
        background-color: rgba(45, 212, 191, 0.1) !important;
    }
    /* Violeta para Estado */
    .btn-estado div.stLinkButton > a {
...
# ==========================================
# NOMENCLADORES (Encerrados en su clase para no mezclarse)
# ==========================================
with st.expander("NOMENCLADORES"):
    st.markdown('<div class="nomen-box">', unsafe_allow_html=True)
...
# ==========================================
# PEDIDOS (Cada uno con su color específico)
# ==========================================
with st.expander("PEDIDOS"):
    col_l, col_s, col_e = st.columns(3)
    with col_l:
        st.markdown('<div class="btn-leche">', unsafe_allow_html=True)
        st.link_button("PEDIDO DE LECHES", "https://docs.google.com/forms/d/e/1FAIpQLSdieAj2BBSfXFwXR_3iLN0dTrCXtMTcQRTM-OElo5i7JsxMkg/viewform")
        st.markdown('</div>', unsafe_allow_html=True)
    with col_s:
        st.markdown('<div class="btn-sumi">', unsafe_allow_html=True)
        st.link_button("PEDIDO SUMINISTROS", "https://docs.google.com/forms/d/e/1FAIpQLSfMlwRSUf6dAwwpl1k8yATOe6g0slMVMV7ulFao0w_XaoLwMA/viewform")
        st.markdown('</div>', unsafe_allow_html=True)
    with col_e:
        st.markdown('<div class="btn-estado">', unsafe_allow_html=True)
...
# ==========================================
# AGENDAS/MAILS (Lógica corregida)
# ==========================================
@st.cache_data
def cargar_datos():
    try:
