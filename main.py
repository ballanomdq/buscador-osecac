...
# 3. CSS CORREGIDO (CENTRADO TOTAL Y BRILLO)
st.markdown("""
    <style>
    ...
    /* CONTENEDOR MAESTRO: ESTO ARREGLA LA IMAGEN QUE ME MOSTRASTE */
    .centrado-total {
        display: flex;
        flex-direction: row;
        align-items: center;
...
# Usamos una sola línea de markdown para forzar que el logo y el cartel se queden pegados
st.markdown('<div class="centrado-total">', unsafe_allow_html=True)

# Cartel
st.markdown("""
    <div class="capsula-header-mini">
        <div class="shimmer-efecto"></div>
        <p class="titulo-mini">OSECAC MDP / AGENCIAS</p>
    </div>
    """, unsafe_allow_html=True)

# Logo (directamente al lado)
try:
...
# ==========================================
# SECCIONES Y BUSCADORES (TODO ORIGINAL)
# ==========================================
