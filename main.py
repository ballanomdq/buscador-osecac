...
# 3. CSS PERMANENTE (VUELVE EL DISEÑO MINIMALISTA ANTERIOR)
st.markdown("""
    <style>
    ...
    /* Fichas y Buscadores (Tu diseño fijo) */
    .ficha {
...
# === CABECERA COMPACTA: LOGO1 ARRIBA + CÁPSULA ===
st.markdown('<div style="text-align: center; margin-bottom: 30px;">', unsafe_allow_html=True)

# Imagen LOGO1.png arriba para dar aire al diseño
try:
    st.image("LOGO1.png", width=100)
except:
    st.markdown('<p style="color:#94a3b8; font-size:12px;">*</p>', unsafe_allow_html=True)
...
# ==========================================
# ORDEN DE SECCIONES (NOMENCLADORES, PEDIDOS, PÁGINAS, BUSCADORES)
# ==========================================
